...
COMMON_FIELD_DESCRIPTIONS = {
    ...
    "continuation_id": "UUID from previous response's continuation_offer to maintain context and avoid re-sending files. Use exact UUID value only, not a description.",
